...
#目标hive表
ods_weblog_origin="db_weblog.ods_weblog_origin"
ods_click_pageviews="db_weblog.ods_click_pageviews"
ods_click_visit="db_weblog.click_stream_visit"
